/* Copyright (C) 2002 GFRN systems
   ...
   $Log: main.h,v $
	...
	// 2013/11/13: Added "socket2" to ClientInfo, used by AudioDeviceType = OSS
...
typedef struct ClientInfo_TAG {
   int      SN;
   SOCKET   Socket;
// ON1ARF: Added "Socket2" for AudioDeviceType = FIFO (FIFO devices should be unidirectional).
// Socket2 used for outgoing stream
   SOCKET   Socket2;
   IPAdrUnion HisAdr;
   int   Err;
